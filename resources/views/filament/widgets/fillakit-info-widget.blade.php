...
<x-filament-widgets::widget class="fi-filament-info-widget">
    <x-filament::section>
        <div class="fi-filament-info-widget-main">
            <span class="h-5 text-l font-bold text-gray-950 dark:text-white">{{ $viewData['app_name'] }}</span>
            <span
                class="text-xs bg-primary-100 text-gray-500 dark:text-gray-700 px-2 py-0.5 rounded">v{{ $viewData['app_version'] }}</span>

            <p class="fi-filament-info-widget-version">
                Filament
                {{ $viewData['filament_version'] }} ·
                Laravel {{ $viewData['laravel_version'] }} · PHP
                {{ $viewData['php_version'] }} · {{ $viewData['db_version'] }}
            </p>
        </div>

        <div class="fi-filament-info-widget-links">
            <x-filament::link color="gray" href="https://fillakit.notakrista.com/docs" :icon="\Filament\Support\Icons\Heroicon::BookOpen"
            ...
            <x-filament::link color="gray" href="https://github.com/akrista/fillakit"
